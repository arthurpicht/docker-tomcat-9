...
RUN set -eux; \
	export TOMCAT_URL="https://archive.apache.org/dist/tomcat/tomcat-9/v9.0.48/bin/apache-tomcat-9.0.48.tar.gz"; \
	export TOMCAT_FILE=tomcat.tar.gz; \
	export TOMCAT_SHA512_URL="https://archive.apache.org/dist/tomcat/tomcat-9/v9.0.48/bin/apache-tomcat-9.0.48.tar.gz.sha512"; \
